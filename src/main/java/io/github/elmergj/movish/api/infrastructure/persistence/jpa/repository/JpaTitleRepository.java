...
public interface JpaTitleRepository extends JpaRepository<TitleEntity, String> {
    ...
    Optional<TitleEntity> findByUserEntity_IdAndMediaIdAndMediaType(String userEntityId, String mediaId, MediaType mediaType);

    Collection<TitleEntity> findAllByIdIn(Collection<String> ids);
